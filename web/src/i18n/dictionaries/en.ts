const en = {
  ...
  common: {
    ...
    search: "Search",
    searchPlaceholder: "Search cups, plates, cutlery…",
    filters: "Filters",
    sortBy: "Sort by",
    ...
    emptyCartHint: "Browse the catalogue and add the items you need.",
    remove: "Remove",
    close: "Close",
    previous: "Previous",
    next: "Next",
  ...
  auth: {
    ...
    signInBody: "Sign in to manage orders, delivery details and repeat purchases.",
    registerTitle: "Create your account",
    registerBody: "Set up your account for faster ordering and a complete order history.",
    forgotTitle: "Reset your password",
    forgotBody: "Enter your email address and we will send you a password reset link.",
    signIn: "Sign in",
    register: "Register",
    ...
    benefits: [
      ...
      "Reorder everyday supplies faster",
    ],
  },
  ...
  home: {
    ...
    quality: {
      ...
      items: [
        ...
        { code: "HACCP", label: "Hazard analysis & critical control" },
        { code: "FDA-grade", label: "Food-contact material compliance" },
      ],
    },
    testimonials: {
  ...
  products: {
    hero: {
      ...
      subtitle:
        "Eight lines, over three hundred SKUs, produced under one roof and one standard.",
    },
    lineTitle: "In this line",
    exploreLine: "See products",
    customTitle: "Don't see your specification?",
    customBody:
      "We tool custom moulds and print private-label packaging from moderate volumes. Send a drawing or a sample and we will come back with feasibility and pricing.",
  ...
  shop: {
    hero: {
      eyebrow: "Online shop",
      title: "Order packs & cartons",
      subtitle:
        "Retail packs and wholesale cartons, dispatched from stock. Volume pricing applies automatically at checkout.",
    },
    landing: {
      categoriesTitle: "Shop by category",
      categoriesBody: "Choose a category to see its complete product range.",
      topTitle: "Top products",
      topBody: "Our most requested products for everyday business supply.",
      saleTitle: "Sale items",
      saleBody: "Selected mock products currently shown with special pricing.",
      openCategory: "View category",
    },
  ...
  cart: {
    ...
    note: "Prices are indicative. Final wholesale pricing is confirmed on the proforma invoice.",
  },
  ...
  contact: {
    hero: {
      ...
      subtitle:
        "Quotations, samples, private label or an issue with a delivery — one team, one response.",
    },
    form: {
      title: "Send a message",
      subtitle: "We reply to commercial enquiries within one working day.",
      name: "Full name",
      ...
      phonePlaceholder: "+98 …",
      subject: "Subject",
      subjects: ["Request a quotation", "Sample request", "Private label", "Distribution partnership", "Other"],
      message: "Message",
    ...
    departments: {
      title: "Direct lines",
      items: [
        { name: "Sales & quotations", detail: "sales@tarianaoxin.com" },
